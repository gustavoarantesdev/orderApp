                    ...
                    <div class="col">
                        <div class="card rounded-5 shadow">
                            <div class="card-body text-center">
                                ...
                                <p class="card-text"><strong>{endDate}</strong></p>
                                <hr>
                                ...
                                <p class="card-text"><strong>{paymentMethod}</strong></p>
                                <hr>

                                <p class="card-text text-secondary"><small>{daysCount}</small></p>

                                <button class="btn bg-body-secondary p-3 lh-1 rounded-5" type="button" onclick="window.location='index.php?class=OrderFormUpdate&method=update&id={id}'">
