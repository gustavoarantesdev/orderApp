...
<main style="margin-top: 100px">
    <section class="container">
        <div class="bg-body rounded-5 p-3 shadow border col-md-8 col-lg-6 mx-auto">
            ...
            <form action="<?= BASE_URL . '/usuario/store' ?>" method="POST" class="needs-validation" novalidate>
                <div class="mb-3">
                    <label class="form-label">
                        Nome de usuário <span class="text-danger"><b>*</b></span>
                    </label>
                ...
                <div class="mb-3">
                    ...
                    placeholder="Sua senha (mínimo 5 caracteres)" minlength="5" required>
                        <div class="invalid-feedback">
                ...
                <div class="mb-3">
                    <label class="form-label">
                        Confirme a senha <span class="text-danger"><b>*</b></span>
                    </label>
                ...
                <div class="text-center">
                    ...
                    style="width: 8rem;" title="Cadastrar-se">
                        <b>Cadastrar</b>
                    </button>
                </div>
