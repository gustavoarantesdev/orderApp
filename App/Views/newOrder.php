                    ...
                    <div class="card-body text-center">
                        ...
                        <form id="orderForm" action="index.php?class=OrderForm&method=save" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="client_name" class="form-control text-black border-dark-subtle rounded-4 p-3" placeholder="Lívia Couto" required></input>
                            </div>

                            <div class="mb-4">
                                <label for="completion_date" class="form-label"><strong>ENTREGA</strong></label>
                                <input type="text" name="completion_date" id="completion_date" class="completion_date form-control text-black border-dark-subtle rounded-4 p-3" placeholder="01/06/2024" required></input>
                            </div>

                            <div class="mb-4">
                                <label for="completion_time" class="form-label"><strong>HORARIO</strong></label>
                                <input type="text" name="completion_time" id="completion_time" class="completion_time form-control text-black border-dark-subtle rounded-4 p-3" placeholder="20:30" required></input>
                            </div>

                            <div class="mb-4">
                                <label for="order_price" class="form-label"><strong>PREÇO</strong></label>
                                <input type="text" name="order_price" class="order_price form-control text-black border-dark-subtle rounded-4 p-3" placeholder="250,00" required></input>
                            </div>
